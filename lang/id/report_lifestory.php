...
$string['noresponse'] = 'Tidak ada tanggapan yang diterima.';
...
$string['report_lifestory:generateaifeedback'] = 'Hasilkan umpan balik AI tentang kinerja mahasiswa';
$string['searchusers'] = 'Cari pengguna';
$string['select'] = 'Pilih';
$string['selectuser'] = 'Silakan pilih pengguna untuk melihat kisah hidupnya';
$string['unexpected_ai_error'] = 'Kesalahan pemrosesan AI yang tidak terduga: {$a}';
