...
$string['privacy:metadata:ai_provider:fullname'] = 'Nome completo do usuário para fornecer contexto.';
$string['privacy:metadata:ai_provider:userid'] = 'ID do usuário cujo histórico acadêmico é analisado.';
$string['range'] = 'Intervalo';
$string['report_lifestory:generateaifeedback'] = 'Gerar feedback com IA sobre o desempenho do estudante';
