...
$string['privacy:metadata:ai_provider:courseids'] = 'Liste des identifiants des cours auxquels l’utilisateur est inscrit.';
$string['privacy:metadata:ai_provider:coursenames'] = 'Noms des cours auxquels l’utilisateur est inscrit.';
$string['privacy:metadata:ai_provider:fullname'] = 'Nom complet de l’utilisateur pour fournir un contexte.';
$string['privacy:metadata:ai_provider:userid'] = 'ID de l’utilisateur dont l’historique académique est analysé.';
$string['range'] = 'Plage';
$string['report_lifestory:generateaifeedback'] = 'Générer un retour avec l’IA sur la performance de l’étudiant';
