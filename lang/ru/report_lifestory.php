...
$string['error_ai_service'] = 'Ошибка сервиса ИИ: {$a}';
...
$string['lifestory:view'] = 'Просмотреть отчет об истории жизни';
$string['noreportdata'] = 'Нет доступных данных отчета.';
$string['noresponse'] = 'Ответ не получен.';
$string['pluginname'] = 'История жизни студента с ИИ';
...
$string['privacy:metadata:ai_provider:courseids'] = 'Список идентификаторов курсов, на которые зарегистрирован пользователь.';
$string['privacy:metadata:ai_provider:coursenames'] = 'Названия курсов, на которые зарегистрирован пользователь.';
