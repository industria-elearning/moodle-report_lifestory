...
$string['privacy:metadata:ai_provider:courseids'] = 'Список идентификаторов курсов, на которые пользователь записан.';
...
$string['report_lifestory:generateaifeedback'] = 'Создать отзыв с помощью ИИ о результатах студента';
